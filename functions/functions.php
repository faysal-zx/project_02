...
function getPro(){
    ...
    while($row_products = mysqli_fetch_array($run_products)){
        ...
        if ($row_manufacturer) {
            ...
            $manufacturer_name = "Unknown Club"; // default value if no manufacturer is found
        }
...
function getProducts(){
    ...
    while($row_products = mysqli_fetch_array($run_products)){
        ...
        if ($row_manufacturer) {
            ...
            $manufacturer_name = "Unknown Manufacturer"; // default value if no manufacturer is found
        }
...
function getPaginator(){
    ...
    if(!empty($aPath)){
        echo "&" . $aPath . "'>First Page</a></li>";
    } else {
        echo "'>First Page</a></li>";
    }

    for($i = 1; $i <= $total_pages; $i++){
        echo "<li><a href='shop.php?page=" . $i;
